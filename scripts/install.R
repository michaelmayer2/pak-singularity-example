...
devtools::install_github('davidsjoberg/ggsankey@3e171a8',lib=libdir)
devtools::install_github('Mikata-Project/ggthemr@f04aca6',lib=libdir)
devtools::install_github('federicomarini/pcaExplorer@4a87c29',lib=libdir, dependencies = TRUE)
devtools::install_github('federicomarini/ideal@6a0b6df',lib=libdir, dependencies = TRUE)
devtools::install_github('cellgeni/sceasy@0cfc0e3',lib=libdir)
